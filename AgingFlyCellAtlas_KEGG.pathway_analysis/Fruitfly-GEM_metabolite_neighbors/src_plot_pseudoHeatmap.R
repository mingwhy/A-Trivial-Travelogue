...
pdf('pseudoHeatmap.pdf',useDingbats = T)
N=7
for(i in 1:3){
...
my.col0=RColorBrewer::brewer.pal(7,'Reds')
barplot(1:length(my.col0),col=my.col0)
...
pdf('pseudoHeatmap1.pdf',useDingbats = T)
N=7
for(i in 0:2){
  if(i==1){my.col=my.col1}else if(i==2){my.col=my.col2}else if(i==0){my.col=my.col0}
  mat=Matrix::Matrix(runif(N^2),N,N)
  mat=as.matrix(Matrix::forceSymmetric(mat))
  axis.tick=0:N
  x=0:nrow(mat) 
...
pdf("pseudoHeatmap2.pdf",useDingbats = T)
