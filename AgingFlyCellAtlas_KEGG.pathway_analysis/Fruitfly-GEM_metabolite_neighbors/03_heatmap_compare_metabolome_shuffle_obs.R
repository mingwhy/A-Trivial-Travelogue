...
saveRDS(df.mz.out,'metabolite_cell.type_Pvalue_remove0.rds')
...
mat.mz.names<-mz.age.betas[match(colnames(mat),mz.age.betas$KEGGid),]$mz
mat.metabolite.names=mat;
colnames(mat.metabolite.names)=mat.mz.names
...
pdf("heatmap_shuffle_metabolome_Pval0.01_remove0.pdf",width=10,height=6.5)
#png("heatmap_shuffle_metabolome_Pval0.05.png",width=10,height=5,units="in",res=1200)
Heatmap(mat.metabolite.names,  name='Pearson\'s r',
