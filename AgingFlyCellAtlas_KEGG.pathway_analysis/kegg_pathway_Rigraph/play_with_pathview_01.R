...
my_producer$cluster   #"hsa00340_SIF",Histidine metabolism
...
#in `pathview.R`
                         ...
                         cpd.data=inp.cpd;
#                         xml.file=NULL,
                         pathway.id='00340'; #"hsa00340_SIF",Histidine metabolism
                         species = "hsa";
                         kegg.dir=".";
                   cpd.idtype="kegg";
                   gene.idtype="entrez";
                  ...
                  #kegg.native=TRUE; #`hsa00340.pathview.png`
                   kegg.native=FALSE; #`hsa00340.pathview.pdf`
                   map.null=TRUE;
                   expand.node=FALSE; #g
                           split.group=FALSE; #g
