...
Rcpp::List achrTest(const Rcpp::List& model, const Rcpp::List& state, const arma::mat& warmupPnts, const int nPnts, const int stepsPerPnt) {
    ...
    while (pointCount < nPnts) {
         ...
         Rcpp::Rcout << "ACHR round1..." << pointCount << "\n";
        ...
        while (stepCount < stepsPerPnt) {
            ...
            Rcpp::Rcout << "ACHR stepCount..." << pointCount << "\n";
