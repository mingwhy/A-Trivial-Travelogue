...
indir=rpair_dir_path
outfile=output_folder + project_folder +'component_data.pickle'
...
G = nx.read_gpickle(indir + 'rpairs_' + 'bioDB' + '_hp.gpickle')
G.nodes
G.edges
G.get_edge_data(784904667, 1469381842)
nx.shortest_path(G, 90913, 98950388)

G2 = nx.read_gpickle(indir + 'rpairs_' + 'KEGG' + '_hp.gpickle')
nx.shortest_path(G2,702254,83313)
G2.get_edge_data(702254, 1467987578)
...
paths=nx.all_simple_paths(G, 90913, 98950388)
len(list(paths))
