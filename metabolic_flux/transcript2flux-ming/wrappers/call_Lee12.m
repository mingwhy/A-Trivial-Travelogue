...
%       gene_exp = gene_exp;
%       gene_exp_sd =  [];
%       gene_scale_rxn = model.subtrate_transport_rxn;
%       flux_scale_rxn = model.subtrate_uptake_rxn;
%       flux  = uptake_rate;    
    ...
    % scale back by uptk rate, need to run `constrain_model_to_data` to get non-zero values
